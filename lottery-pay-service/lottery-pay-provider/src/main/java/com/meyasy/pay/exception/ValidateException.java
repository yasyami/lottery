package com.meyasy.pay.exception;
...
public class ValidateException extends RuntimeException {
    ...
    public ValidateException(String errorCode) {
        super(errorCode);
        this.errorCode= PayReturnCodeEnum.SYS_PARAM_NOT_RIGHT.getCode();
        this.errorMessage= PayReturnCodeEnum.SYS_PARAM_NOT_RIGHT.getMsg(errorCode);
    }
